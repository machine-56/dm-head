...
def compsignup(request):
    return render(request,'compsignup.html')
...
#         company = None
#     print("hello")
#     return render(request, 'headdash.html', {
#         'user': user,
#         'company': company,
#         'name':name
#     })
...
def teamlead(request):
    ...
    try:
        ...
        company = None
    print("hello")
    return render(request, 'teamleaddash.html', {
        'user': user,
        'company': company,
        'name':name
    })
...
def executive(request):
    ...
    try:
        ...
        company = None
    print("hello")
    return render(request, 'executivedash.html', {
        'user': user,
        'company': company,
        'name':name
    })
...
def telecaller(request):
    ...
    try:
        ...
        company = None
    print("hello")
    return render(request, 'telecallerdash.html', {
        'user': user,
        'company': company,
        'name':name
    })
...
def empsignup(request):
    ...
    return render(request, 'empsignup.html', {'departments': departments})
